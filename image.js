(function () {
  ...
  */
  ...
  var render$1 = function render(cache, props, theme, ref) {
    ...
    var possiblyStyleElement = /*#__PURE__*/react_11(Noop$1, null);
    ...
    if (!isBrowser && rules !== undefined) {
      ...
      possiblyStyleElement = /*#__PURE__*/react_11("style", (_ref = {}, _ref["data-emotion-" + cache.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
        __html: rules
      }, _ref.nonce = cache.sheet.nonce, _ref));
    } // Need to return the same number of siblings or else `React.useId` will cause hydration mismatches.


    return /*#__PURE__*/react_11(react_3, null, possiblyStyleElement, ele);
  ...
  withEmotionCache(function (props, context) {
    return /*#__PURE__*/react_11(ThemeContext.Consumer, null, function (theme) {
      ...
      hasRendered = true;
      var possiblyStyleElement = /*#__PURE__*/react_11(Noop, null);

      if (!isBrowser && rules.length !== 0) {
        var _ref;

        possiblyStyleElement = /*#__PURE__*/react_11("style", (_ref = {}, _ref["data-emotion-" + context.key] = serializedHashes.substring(1), _ref.dangerouslySetInnerHTML = {
          __html: rules
